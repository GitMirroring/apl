...
that text that the label should have. We choose *Employee* for *label1* and
*Position* for *label2*.
...
include::../src/Gtk/Gtk_events1.adoc[]
...
of callbacks satisfies the above then they:
...
them but we will explain them all) starts with the core name of a widget
...
----
→ select the new window and set the (topmost) property ID in tab General to window1
----
...
include::../src/Gtk/Gtk_functions.adoc[]
...
include::../src/Gtk/Gtk_events2.adoc[]
